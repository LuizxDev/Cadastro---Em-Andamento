    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (escolha) {
            case 0:
                ...
                usuario.setLogin_usuario(JOptionPane.showInputDialog(null, "Digite seu login:", "Login", JOptionPane.PLAIN_MESSAGE));

                usuario.setSenha_usuario(JOptionPane.showInputDialog(null, "Digite sua senha:", "Senha", JOptionPane.PLAIN_MESSAGE));
